...
ERRORS = {
    "en": {
        ...
        "search_not_configured": "Internet search is not configured. Enable a "
        "supported AGY search provider or SearXNG with "
        "JSON output.",
        ...
        "photo_caption_unsupported": "A photo report cannot also store a text note "
        "yet. Send one photo with only /report TASK_ID "
        "in its caption.",
        "photo_report_expired": "This photo report expired or its task changed. "
        "Review the task and send the photo again.",
        "photo_single_required": "Send one photo per task report, not an album.",
        "photo_target_required": "Specify the task with /report TASK_ID or reply to "
        "its task message.",
        "photo_unavailable": "The photo could not be downloaded. Send it again.",
        "provider_images_unsupported": "This provider does not support photo input. "
        "Configure an image-capable provider.",
        ...
        "image_busy": "Another image request is already in progress. Try again "
        "later; no second generation was started.",
        "image_invalid": "The image result could not be verified. No successful "
        "image result is available.",
        "image_rejected": "The image provider rejected this request. Review its "
        "supported model and parameters.",
        "image_submission_uncertain": "The image server may have accepted this "
        "request. Check its current status before "
        "starting another generation.",
        "image_model_unavailable": "The selected image model or required workflow "
        "component is unavailable. Choose installed "
        "models and a supported preset.",
        "provider_search_unsupported": "This AGY gateway has not provided supported "
        "search evidence. Enable and configure its "
        "search capability or use another search "
        "source.",
        "image_too_large": "The generated image exceeds the supported file or image-size limit.",
        "image_delivery_uncertain": "Telegram may already have received this image. "
        "It will not be resent automatically.",
        "image_unavailable": "This image service, configuration or cached result is "
        "no longer available. Review its current status.",
        "provider_quota_exceeded": "The provider quota is exhausted. Try later or "
        "configure an available fallback.",
    },
    "ru": {
        ...
        "search_not_configured": "Интернет-поиск не настроен. Включите "
        "поддерживаемый поиск AGY или SearXNG с "
        "JSON-форматом.",
        ...
        "photo_caption_unsupported": "Фотоотчёт пока не сохраняет текстовую "
        "заметку. Отправьте одно фото только с "
        "подписью /report ID_ЗАДАЧИ.",
        "photo_report_expired": "Срок обработки фото истёк или задача изменилась. "
        "Проверьте задачу и отправьте фото снова.",
        "photo_single_required": "Отправьте одно фото для отчёта по задаче, а не альбом.",
        "photo_target_required": "Укажите задачу: /report ID_ЗАДАЧИ — или ответьте "
        "на сообщение о задаче.",
        "photo_unavailable": "Не удалось загрузить фото. Отправьте его снова.",
        "provider_images_unsupported": "Эта модель не поддерживает фотографии. "
        "Настройте модель с поддержкой изображений.",
        ...
        "image_busy": "Другой запрос изображения уже выполняется. Попробуйте позже; "
        "вторая генерация не запущена.",
        "image_invalid": "Не удалось проверить результат генерации. Подтверждённого "
        "изображения нет.",
        "image_rejected": "Провайдер изображений отклонил запрос. Проверьте "
        "поддерживаемую модель и параметры.",
        "image_submission_uncertain": "Сервер изображений мог принять запрос. "
        "Проверьте его текущий статус перед новой "
        "генерацией.",
        "image_model_unavailable": "Выбранная модель изображения или нужный "
        "компонент схемы недоступны. Выберите "
        "установленные модели и поддерживаемую схему.",
        "provider_search_unsupported": "Этот шлюз AGY не предоставил поддерживаемые "
        "результаты поиска. Настройте его поисковую "
        "возможность или выберите другой источник "
        "поиска.",
        "image_too_large": "Созданное изображение превышает допустимый размер файла "
        "или изображения.",
        "image_delivery_uncertain": "Telegram уже мог получить это изображение. "
        "Автоматической повторной отправки не будет.",
        "image_unavailable": "Этот сервис изображений, его настройка или "
        "сохранённый результат больше недоступны. Проверьте "
        "текущий статус.",
        "provider_quota_exceeded": "Квота провайдера исчерпана. Попробуйте позже "
        "или настройте доступный резервный провайдер.",
    },
    "uk": {
        ...
        "search_not_configured": "Інтернет-пошук не налаштовано. Увімкніть "
        "підтримуваний пошук AGY або SearXNG із "
        "JSON-форматом.",
        ...
        "photo_caption_unsupported": "Фотозвіт поки не зберігає текстову нотатку. "
        "Надішліть одне фото лише з підписом /report "
        "ID_ЗАВДАННЯ.",
        "photo_report_expired": "Строк обробки фото минув або завдання змінилося. "
        "Перевірте завдання й надішліть фото знову.",
        "photo_single_required": "Надішліть одне фото для звіту про завдання, а не альбом.",
        "photo_target_required": "Укажіть завдання: /report ID_ЗАВДАННЯ — або дайте "
        "відповідь на повідомлення про завдання.",
        "photo_unavailable": "Не вдалося завантажити фото. Надішліть його знову.",
        "provider_images_unsupported": "Ця модель не підтримує фотографії. "
        "Налаштуйте модель із підтримкою зображень.",
        ...
        "image_busy": "Інший запит зображення вже виконується. Спробуйте пізніше; "
        "другу генерацію не запущено.",
        "image_invalid": "Не вдалося перевірити результат генерації. Підтвердженого "
        "зображення немає.",
        "image_rejected": "Провайдер зображень відхилив запит. Перевірте "
        "підтримувану модель і параметри.",
        "image_submission_uncertain": "Сервер зображень міг прийняти запит. "
        "Перевірте його поточний стан перед новою "
        "генерацією.",
        "image_model_unavailable": "Обрана модель зображення або потрібний "
        "компонент схеми недоступні. Оберіть установлені "
        "моделі та підтримувану схему.",
        "provider_search_unsupported": "Цей шлюз AGY не надав підтримуваних "
        "результатів пошуку. Налаштуйте його "
        "пошукову можливість або оберіть інше "
        "джерело пошуку.",
        "image_too_large": "Створене зображення перевищує допустимий розмір файлу або зображення.",
        "image_delivery_uncertain": "Telegram уже міг отримати це зображення. "
        "Автоматичного повторного надсилання не буде.",
        "image_unavailable": "Цей сервіс зображень, його налаштування або "
        "збережений результат більше недоступні. Перевірте "
        "поточний стан.",
        "provider_quota_exceeded": "Квоту провайдера вичерпано. Спробуйте пізніше "
        "або налаштуйте доступного резервного "
        "провайдера.",
    },
}
