...
COMMANDS = (
    ...
    (
        "draw",
        "Generate a private image",
        "Создать личное изображение",
        "Створити особисте зображення",
    ),
    ("images", "My image request status", "Статус моих изображений", "Статус моїх зображень"),
)
